...
//  - página completa /cuenta/[id] (sin onCerrar)
//  - panel superpuesto sobre el Tablero (con onCerrar)
export default function CuentaVista({ id, onCerrar }) {
    ...
    <div className="doc-wrap">
      <div className="no-print barra">
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          {onCerrar && <a className="btn-sec" href={`/cuenta/${id}`} target="_blank" rel="noreferrer" title="Abrir en una pestaña nueva">↗</a>}
        </div>
      </div>
      ...
      <style>{`
        ...
        .barra{display:flex;justify-content:space-between;margin-bottom:16px;gap:8px;flex-wrap:wrap}
        ...
        .btn-sec{background:#eef1f6;color:#334155;border:1px solid #e3e8ef;border-radius:8px;padding:10px 16px;text-decoration:none;font-size:14px;font-weight:600;cursor:pointer;display:inline-flex;align-items:center}
