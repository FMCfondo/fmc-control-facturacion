...
// Deja la identificación como la exige SIIGO: SOLO alfanumérica (quita puntos de miles,
// espacios, guiones y cualquier símbolo). Ej: "1.073.712.322" -> "1073712322", "12 345" -> "12345".
export const limpiarId = (v) => String(v ?? "").replace(/[^A-Za-z0-9]/g, "");
