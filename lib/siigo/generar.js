...
// Buffer para subir a Supabase Storage (servidor o cliente).
export function aBuffer(file) {
  return XLSX.write(file.wb, { ...file.opts, type: "array", bookType: file.opts.bookType || "xlsx" });
}
